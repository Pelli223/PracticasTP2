...
public class Main {
	...
	private static void startBatchMode() throws Exception {
		...
		if(_expOut != null) {
			...
			control = new ControllerComparing(_bodyFactory, sim, expOut, _stateComparatorFactory.createInstance(_stateComparatorInfo));
		}
		else {
			control = new ControllerWithOutComparing(_bodyFactory, sim);
		}
